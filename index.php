...
<section class="relative bg-law-blue text-white min-h-[90vh] flex items-center">
    <div class="absolute inset-0 overflow-hidden">
        ...
        <img src="https://images.unsplash.com/photo-1589829085413-56de8ae18c73?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
            alt="Law Office" class="w-full h-full object-cover grayscale opacity-40">
    </div>
    ...
    <div class="container mx-auto px-8">
        <div class="flex flex-col md:flex-row items-center gap-20">
            <div class="md:w-1/2 relative">
                <div
                    class="absolute -top-10 -left-10 w-40 h-40 bg-law-gray rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-blob">
                </div>
                <div
                    class="absolute -bottom-10 -right-10 w-40 h-40 bg-law-gold-light rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-blob animation-delay-2000">
                </div>
                <img src="https://images.unsplash.com/photo-1505664194779-8beaceb93744?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                    alt="Legal Consultation"
                    class="relative rounded-sm shadow-2xl shadow-blue-900/20 object-cover h-[500px] w-full z-10">
                <!-- Decorative border -->
...
<section class="py-24 bg-slate-50">
    <div class="container mx-auto px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div class="relative z-10 text-center">
                <div
                    class="w-24 h-24 bg-law-gold border-4 border-slate-100 rounded-full flex items-center justify-center text-white shadow-lg mx-auto mb-8">
    ...
    <div class="container mx-auto px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <a href="services.php#family"
                class="group bg-white p-10 rounded-sm shadow-soft hover:shadow-2xl hover:shadow-blue-900/5 transition-all duration-500 transform hover:-translate-y-1 relative overflow-hidden">
                <div
                    class="absolute top-0 left-0 w-1 h-full bg-law-gold transform -translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                </div>
                <div
                    class="w-14 h-14 bg-slate-50 rounded-full flex items-center justify-center text-law-blue mb-8 group-hover:bg-law-blue group-hover:text-white transition-colors duration-300">
                ...
                <span
                    ...
                    Utforsk <svg class="w-3 h-3 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="services.php#social"
                class="group bg-white p-10 rounded-sm shadow-soft hover:shadow-2xl hover:shadow-blue-900/5 transition-all duration-500 transform hover:-translate-y-1 relative overflow-hidden">
                <div
                    class="absolute top-0 left-0 w-1 h-full bg-law-blue transform -translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                </div>
                <div
                    class="w-14 h-14 bg-slate-50 rounded-full flex items-center justify-center text-law-blue mb-8 group-hover:bg-law-blue group-hover:text-white transition-colors duration-300">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="container mx-auto px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 shadow-soft rounded-sm border-t-4 border-law-gold relative h-full flex flex-col">
                ...
                <p class="text-slate-600 font-light italic mb-6 leading-relaxed flex-grow">
                    "Jeg stod i en svært vanskelig familiesituasjon, og teamet hos Patricks håndterte det med stor
                    profesjonalitet og empati. De forklarte alt tydelig og kjempet for mine rettigheter."
                </p>
                <div class="text-sm mt-auto">
            ...
            <div class="bg-white p-8 shadow-soft rounded-sm border-t-4 border-law-gold relative h-full flex flex-col">
                ...
                <p class="text-slate-600 font-light italic mb-6 leading-relaxed flex-grow">
                    "Å navigere i NAV-systemet føltes umulig frem til jeg kontaktet Patricks Juridisk Senter. Deres
                    ekspertise var tydelig fra dag én, og vi fikk omgjort vedtaket."
                </p>
                <div class="text-sm mt-auto">
            ...
            <div class="bg-white p-8 shadow-soft rounded-sm border-t-4 border-law-gold relative h-full flex flex-col">
                ...
                <p class="text-slate-600 font-light italic mb-6 leading-relaxed flex-grow">
                    "Profesjonelle, pålitelige og resultatorienterte. De hjalp meg med søknad om oppholdstillatelse og
                    gjorde hele prosessen stressfri."
                </p>
                <div class="text-sm mt-auto">
            ...
            <div class="bg-white p-8 shadow-soft rounded-sm border-t-4 border-law-gold relative h-full flex flex-col">
                ...
                <p class="text-slate-600 font-light italic mb-6 leading-relaxed flex-grow">
                    "Jeg satt fast i visumprosessen i flere måneder. Patrick grep inn med visa fast tracking og fikk det
                    godkjent på uker. Effektivt og profesjonelt."
                </p>
                <div class="text-sm mt-auto">
            ...
            <div class="bg-white p-8 shadow-soft rounded-sm border-t-4 border-law-gold relative h-full flex flex-col">
                ...
                <p class="text-slate-600 font-light italic mb-6 leading-relaxed flex-grow">
                    "Da barnevernet ble involvert, var jeg livredd. Patricks Juridisk Senter stod ved min side hele
                    veien og hjalp med å bringe familien min sammen igjen."
                </p>
                <div class="text-sm mt-auto">
            ...
            <div class="bg-white p-8 shadow-soft rounded-sm border-t-4 border-law-gold relative h-full flex flex-col">
                ...
                <p class="text-slate-600 font-light italic mb-6 leading-relaxed flex-grow">
                    "Jeg fikk utmerket rådgivning angående skifteoppgjøret mitt. Advokaten var skarp, forberedt og
                    sørget for at jeg fikk en rettferdig avtale."
                </p>
                <div class="text-sm mt-auto">
            ...
            <div class="bg-white p-8 shadow-soft rounded-sm border-t-4 border-law-gold relative h-full flex flex-col">
                ...
                <p class="text-slate-600 font-light italic mb-6 leading-relaxed flex-grow">
                    "Anbefales på det sterkeste! De håndterte min klage til UNE med stor dyktighet, og vi oppnådde et
                    positivt resultat. Jeg er evig takknemlig."
                </p>
                <div class="text-sm mt-auto">
            ...
            <div class="bg-white p-8 shadow-soft rounded-sm border-t-4 border-law-gold relative h-full flex flex-col">
                ...
                <p class="text-slate-600 font-light italic mb-6 leading-relaxed flex-grow">
                    "Raskt, effektivt og profesjonelt. Patrick gjorde visumprosessen for familiegjenforening så enkel
                    gjennom visa fast tracking. Anbefales på det sterkeste!"
                </p>
                <div class="text-sm mt-auto">
...
<section class="py-24 bg-white">
    <div class="container mx-auto px-8">
        <div class="flex flex-col md:flex-row items-center gap-16">
            <div class="md:w-1/2">
                <img src="assets/images/ceo.jpeg" alt="Our Team"
                    class="rounded-sm shadow-xl shadow-blue-900/10 grayscale hover:grayscale-0 transition-all duration-700">
            </div>
            <div class="md:w-1/2">
...
<section id="contact-form" class="bg-law-blue py-24 relative overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-10"
        style="background-image: radial-gradient(#c5a059 1px, transparent 1px); background-size: 32px 32px;"></div>
        ...
        <div class="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div class="lg:w-1/2 text-white">
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex items-start">
                        <div
                            class="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center text-law-gold mr-6 flex-shrink-0 backdrop-blur-sm border border-white/10">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
            ...
            <div class="lg:w-1/2">
                <div class="bg-white p-10 rounded-sm shadow-2xl relative">
                    ...
                    <form action="submit_contact.php" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label for="message"
                                class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Melding</label>
                            <textarea id="message" name="message" rows="3" required
                                class="w-full bg-slate-50 border-slate-200 rounded-sm focus:border-law-blue focus:ring-0 transition-colors py-3 px-4 text-slate-700"></textarea>
                        </div>
                        <button type="submit"
                            class="w-full bg-law-gold text-white font-bold tracking-widest uppercase text-xs py-4 px-6 rounded-sm hover:bg-law-blue transition-colors duration-300 shadow-lg shadow-yellow-900/10">
                            Send melding
                        </button>
                    </form>
                </div>
