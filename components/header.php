...
<body class="bg-slate-50 text-slate-800 flex flex-col min-h-screen selection:bg-law-gold selection:text-white">
    ...
    <header class="glass-header fixed w-full z-50 transition-all duration-300">
        <div class="container mx-auto px-8 py-5 flex justify-between items-center">
            ...
            <a href="index.php" class="group flex items-center gap-3">
                ...
                <div class="flex flex-col">
                    ...
                    <span
                        class="text-[10px] font-medium text-slate-500 uppercase tracking-[0.25em] leading-none mt-1">Law
                        Firm</span>
                </div>
            </a>
            ...
            <nav class="hidden md:flex items-center space-x-10">
                <a href="index.php"
                    class="text-xs font-semibold uppercase tracking-widest text-slate-500 hover:text-law-blue transition-colors duration-300">Home</a>
                <a href="about.php"
                    class="text-xs font-semibold uppercase tracking-widest text-slate-500 hover:text-law-blue transition-colors duration-300">About</a>
                <div class="relative group h-full flex items-center">
                    ...
                    <div
                        ...
                        <a href="services.php#family"
                            class="block px-6 py-3 text-sm text-slate-600 hover:bg-slate-50 hover:text-law-blue transition border-b border-slate-50">Family
                            Law</a>
                        <a href="services.php#social"
                            class="block px-6 py-3 text-sm text-slate-600 hover:bg-slate-50 hover:text-law-blue transition border-b border-slate-50">Social
                            Security & NAV</a>
                        <a href="services.php#child"
                            class="block px-6 py-3 text-sm text-slate-600 hover:bg-slate-50 hover:text-law-blue transition border-b border-slate-50">Child
                            Welfare</a>
                        <a href="services.php#immigration"
                            class="block px-6 py-3 text-sm text-slate-600 hover:bg-slate-50 hover:text-law-blue transition">Immigration
                            Law</a>
                    </div>
                </div>
                <a href="contact.php"
                    class="text-xs font-bold uppercase tracking-widest bg-law-blue text-white px-6 py-3 rounded-sm hover:bg-law-gold transition-colors duration-300 shadow-lg shadow-blue-900/10">Contact
                    Us</a>
            </nav>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-slate-100 absolute w-full shadow-xl">
            <a href="index.php"
                class="block px-8 py-4 text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-law-blue border-b border-slate-50">Home</a>
            <a href="about.php"
                class="block px-8 py-4 text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-law-blue border-b border-slate-50">About
                Us</a>
            <a href="services.php"
                class="block px-8 py-4 text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-law-blue border-b border-slate-50">Practice
                Areas</a>
