...
<div class="bg-law-blue text-white pt-40 pb-20 relative overflow-hidden">
     <div class="absolute inset-0 opacity-20">
        <img src="https://images.unsplash.com/photo-1423666639041-f14ad798ac0d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80" alt="Contact Us" class="w-full h-full object-cover">
    </div>
    ...
    <div class="container mx-auto px-8 relative z-10 text-center">
        <h1 class="text-4xl md:text-5xl font-serif font-light mb-4">Contact Us</h1>
        <div class="flex justify-center items-center text-xs font-semibold tracking-widest text-slate-400 uppercase">
            <a href="index.php" class="hover:text-white transition-colors">Home</a> <span class="mx-4 text-law-gold">/</span> <span class="text-white">Contact</span>
        </div>
    </div>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div class="space-y-12">
                <div>
                    ...
                    <h2 class="text-3xl font-serif font-light text-law-blue mb-6">We Are Here to Help</h2>
                    <p class="text-slate-500 mb-8 leading-loose font-light">
                        We offer a free initial assessment of your case. Please fill out the form, or contact us directly via phone or email. All inquiries are treated with strict confidentiality.
                    </p>
                </div>

                <div class="space-y-8">
                    <div class="flex items-start group">
                        <div class="w-12 h-12 bg-white shadow-soft rounded-full flex items-center justify-center text-law-gold mr-6 flex-shrink-0 group-hover:bg-law-blue group-hover:text-white transition-colors duration-300">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        </div>
                        <div>
                            <h4 class="font-serif font-medium text-law-blue text-lg">Visit Us</h4>
                    ...
                    <!-- <div class="flex items-start group">
                        ...
                        <div>
                            <h4 class="font-serif font-medium text-law-blue text-lg">Call Us</h4>
                            <p class="text-slate-500 font-light mt-1">+47 51 89 60 50</p>
                        </div>
                    </div> -->
                    ...
                    <div class="flex items-start group">
                        ...
                        <div>
                            <h4 class="font-serif font-medium text-law-blue text-lg">Email Us</h4>
                ...
                <!-- Additional Info -->
                <div class="bg-white border border-slate-100 p-8 rounded-sm shadow-soft mt-12">
                     <h4 class="font-serif font-medium text-law-blue text-lg mb-6">Office Information</h4>
                     <div class="space-y-4">
                         <div>
                             <h5 class="text-xs font-bold text-law-gold uppercase tracking-widest mb-1">Opening Hours</h5>
                             <p class="text-slate-500 font-light text-sm">Mon - Fri: 08:00 - 16:00<br>Sat - Sun: Closed</p>
                         </div>
                         <hr class="border-slate-100">
                         <div>
                             <h5 class="text-xs font-bold text-law-gold uppercase tracking-widest mb-1">Public Transport</h5>
                             <p class="text-slate-500 font-light text-sm">We are located a 5-minute walk from Stavanger Train Station and the main bus terminal.</p>
                         </div>
                         <hr class="border-slate-100">
                         <div>
                             <h5 class="text-xs font-bold text-law-gold uppercase tracking-widest mb-1">Parking</h5>
                             <p class="text-slate-500 font-light text-sm">Nearest parking is Jorenholmen P-hus (3 min walk) or Kyrre P-hus.</p>
                         </div>
                     </div>
                </div>
            </div>
            ...
            <!-- Contact Form -->
            <div class="bg-white p-10 rounded-sm shadow-soft border border-slate-100 relative">
                <div class="absolute top-0 left-0 w-full h-1 bg-law-blue"></div>
                <h3 class="text-2xl font-serif font-light text-law-blue mb-8">Send a Message</h3>
                ...
                <form action="submit_contact.php" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="4" required class="w-full bg-slate-50 border-slate-200 rounded-sm focus:border-law-blue focus:ring-0 transition-colors py-3 px-4 text-slate-700"></textarea>
                    </div>
