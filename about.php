...
<div class="bg-law-blue text-white pt-40 pb-20 relative overflow-hidden">
    ...
    <div class="container mx-auto px-8 relative z-10 text-center">
        ...
        <div class="flex justify-center items-center text-xs font-semibold tracking-widest text-slate-400 uppercase">
            <a href="index.php" class="hover:text-white transition-colors">Hjem</a> <span
                class="mx-4 text-law-gold">/</span> <span class="text-white">Om oss</span>
        </div>
    </div>
</div>
        ...
        <div class="flex flex-col lg:flex-row gap-20 items-start">
            <div class="lg:w-2/3">
                ...
                <div>
                    <span class="text-law-gold text-xs font-bold tracking-[0.2em] uppercase mb-4 block">Vår
                        filosofi</span>
                    <h2 class="text-4xl font-serif font-light text-law-blue mb-8 leading-tight">Vi kjemper for dine
                        rettigheter med integritet</h2>

                    <div class="prose prose-lg text-slate-600 font-light">
                        <p class="mb-6 leading-loose">
                            Patricks Juridisk Senter er et spesialisert advokatfirma som fokuserer på <span
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="flex items-start">
                        <div
                            class="flex-shrink-0 w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-law-gold mt-1">
            ...
            <div class="lg:w-1/3 space-y-8 lg:sticky lg:top-32">
                ...
                <div class="relative rounded-sm overflow-hidden shadow-2xl shadow-blue-900/10">
                    <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
                        alt="Meeting" class="w-full object-cover">
    ...
    <div class="container mx-auto px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="text-center">
                <div
                    class="w-16 h-16 border border-law-gold rounded-full flex items-center justify-center mx-auto mb-6 text-law-gold">
            ...
            <div class="w-full md:w-5/12 lg:w-1/3">
                <div class="bg-white rounded-sm shadow-soft overflow-hidden group">
                    <div class="h-80 overflow-hidden relative">
                        <img src="assets/images/ceo.jpeg" alt="Lawyer"
